        ...
        if ($day == "" || $month == "" || $year == "") {
            ...
            if ($flag) {
                ...
                if ($pos_month > $pos_cur_month && $day > $cur_day) {
                    ...
                    $month_diff = 12 - $pos_month;
                    $month_diff += $pos_cur_month - 1;
                    $diff = 30 - $day;
